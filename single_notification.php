...
<a href="<?php echo $link ?>" style="text-decoration: none;background:  #292c358a;border-radius:20px 20px 20px 20px / 20px 20px 20px 20px;box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12);">
	<div id="notificationn" style="margin-top: 20px; margin-bottom: 20px; text-decoration: none;background:  #292c358a;border-radius:20px 20px 20px 20px / 20px 20px 20px 20px;box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12); background-color: <?= $color ?>">
		...
		<?php
			if(is_array($actor) && is_array($owner)){
				...
				echo "<img src='".ROOT."$image' style='width:36px;margin:1.50px;float:left;background:  #292c358a;border-radius:20px 20px 20px 20px / 20px 20px 20px 20px;box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12);' />";
				...
				if($notif_row['content_type'] == "post"){
					...
					if($content_row['has_image']){
						...
						echo "
 								<span style='float:right;font-size:11px;color:white;display:inline-block;margin-right:10px;'>'".htmlspecialchars(substr($content_row['post'],0,50))."'</span>
							";
					}
				}else{
				...
				echo "<br>
					...
					<span style='font-size:11px;color:white;display:inline-block;margin-right:10px;'>$date</span>
				";
			}
		?>
	</div>
