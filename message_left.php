	...
	<div id="message_left" style="box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12); background-color:#292c358a; color:white;text-decoration:none;">
		<div>
			...
			<img src="<?php echo ROOT . $image ?>" style="text-decoration:none;width: 75px;margin-right: 4px;border-radius: 50%;box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12); background-color:#292c358a; color:white;">
		</div>
		<div style="width: 100%;">
