...
?>
<div id="blue_bar" style="margin-top:-18px; height: 55px;box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12);">

	<form method="get" action="<?=ROOT?>search">
		<div style="margin-top:0px;width: 95%;margin:auto;font-size: 30px;">
		<img style="width: 50px; algin-item:center; float:left;" src="/facebook-mfs/logomf.png"/>
			<a href="<?=ROOT?>home" class="mybook" style=" color:white;text-decoration: none;margin-left:5%;">Mybook</a> 
			&nbsp &nbsp <input type="text" id="search_boxx" style="algin-item:center;  height: 34px; color:white; background:  #565a665b; width: 230px; border-radius:50px 0px 0px 50px / 50px 0px 0px 50px;border-style: none;border: none;outline: 0;"  name="find" placeholder="Search for people"><button style="color:white; background:  #565a665b;font-size: 14px;border:none; border-radius:0px 50px 50px 0px / 0px 50px 50px 0px;height: 34.00px;  texs-algin:center;text-align: center;">🔍︎</button></input>
