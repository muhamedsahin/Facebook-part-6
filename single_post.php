...
background-position: right;
	...
	<body style="font-family: tahoma; font-family: tahoma; background-color: #212529; text-decoration: none;  ">
			...
			<div style="display: flex;">	
				...
				<!--posts area-->
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px; ">
 					...
 					<div style="border-radius:15px; padding: 10px;background-color: white; background-color: #212529; text-decoration: none; box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12);">
						...
						<?php if(!($is_group_post && $group_data['group_type'] == 'public' && !group_access($_SESSION['mybook_userid'],$group_data,'member'))): ?>
	  					...
	  					<div style="border-radius:15px; padding: 10px;background-color: white;background-color: #212529; text-decoration: none; box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12);">
	 						...
	 						<form method="post" style="" enctype="multipart/form-data">
		 						...
		 						<textarea name="post" style="outline:0;background-color: #212529; text-decoration: none; box-shadow: 0px 1px 5px 3px rgba(0,0,0,0.12);color:white;" placeholder="Post a comment"></textarea>
